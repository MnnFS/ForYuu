...
// Dirubah 
const pengirim = "MnFS";
const nomorWa = "6285172381889" // awalan nomor 0 harus di awalin 62
const textWa = "Bagus Kan Brokk ( Kesannya Dong Kakaa)"
const pesan = `Dan berakhir aku hanya butiran debu yang melihat dan mengagumi mu dari sisi dunia yang lain, dimana tempat yang sangat tenang sunyi dan kesepian hehe :3`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    preConfirm: () => {
      ...
      if (!login) {
        Swal.showValidationMessage(`Masukin Nama Mu Pls Mau Kenalan Wkwk`)
      }
      return { login }
    }
  }).then((result) => {
